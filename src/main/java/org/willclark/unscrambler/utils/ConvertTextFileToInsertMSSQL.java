...
public class ConvertTextFileToInsertMSSQL {
    ...
    public static void main(String... args) throws Exception {
        new ConvertTextFileToInsertMSSQL().run();
    }

    public void run() throws Exception {
        try (FileWriter fw = new FileWriter("./src/main/resources/words-ms.sql"); PrintWriter pw = new PrintWriter(fw)) {
